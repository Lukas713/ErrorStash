  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-0 right-0 z-50 flex h-full w-full flex-col border-l border-border bg-background shadow-2xl duration-300 sm:max-w-md",
...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex shrink-0 flex-col border-b px-6 py-4", className)}
      {...props}
    />
  )
}
